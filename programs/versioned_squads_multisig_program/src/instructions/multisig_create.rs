...
pub struct VersionedMultisigCreateArgsV2 {
...
#[derive(Accounts)]
#[instruction(args: VersionedMultisigCreateArgsV2)]
pub struct VersionedMultisigCreateV2<'info> {
    ...
    #[account(
        init,
        payer = creator,
        space = VersionedMultisig::size(args.members.len()),
...
impl VersionedMultisigCreateV2<'_> {
    ...
    pub fn versioned_multisig_create(ctx: Context<Self>, args: VersionedMultisigCreateArgsV2) -> Result<()> {
