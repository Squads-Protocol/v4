...
// pub use versioned_squads_multisig_program::accounts::BatchAccountsClose as BatchAccountsCloseAccounts;
// pub use versioned_squads_multisig_program::accounts::ConfigTransactionAccountsClose as ConfigTransactionAccountsCloseAccounts;
// pub use versioned_squads_multisig_program::accounts::ConfigTransactionCreate as ConfigTransactionCreateAccounts;
// pub use versioned_squads_multisig_program::accounts::ConfigTransactionExecute as ConfigTransactionExecuteAccounts;
pub use versioned_squads_multisig_program::accounts::VersionedMultisigCreateV2 as MultisigCreateAccountsV2;
pub use versioned_squads_multisig_program::accounts::CreateVersionedProposal as ProposalCreateAccounts;
pub use versioned_squads_multisig_program::accounts::VoteOnVersionedProposal as ProposalVoteAccounts;
// pub use versioned_squads_multisig_program::accounts::SpendingLimitUse as SpendingLimitUseAccounts;
// pub use versioned_squads_multisig_program::accounts::VaultBatchTransactionAccountClose as VaultBatchTransactionAccountCloseAccounts;
// pub use versioned_squads_multisig_program::accounts::VaultTransactionAccountsClose as VaultTransactionAccountsCloseAccounts;
pub use versioned_squads_multisig_program::accounts::VaultTransactionCreate as VaultTransactionCreateAccounts;
pub use versioned_squads_multisig_program::accounts::VaultTransactionExecute as VaultTransactionExecuteAccounts;
// pub use versioned_squads_multisig_program::instruction::ConfigTransactionAccountsClose as ConfigTransactionAccountsCloseData;
use versioned_squads_multisig_program::anchor_lang::AnchorSerialize;
use versioned_squads_multisig_program::anchor_lang::AccountDeserialize;
// pub use versioned_squads_multisig_program::instruction::ConfigTransactionCreate as ConfigTransactionCreateData;
// pub use versioned_squads_multisig_program::instruction::ConfigTransactionExecute as ConfigTransactionExecuteData;
// pub use versioned_squads_multisig_program::instruction::MultisigCreate as MultisigCreateData;
pub use versioned_squads_multisig_program::instruction::CreateVersionedMultisig as MultisigCreateDataV2;
pub use versioned_squads_multisig_program::instruction::VoteOnVersionedProposal as ProposalApproveData;
// pub use versioned_squads_multisig_program::instruction::ProposalCancel as ProposalCancelData;
pub use versioned_squads_multisig_program::instruction::CreateVersionedProposal as ProposalCreateData;
// pub use versioned_squads_multisig_program::instruction::SpendingLimitUse as SpendingLimitUseData;
// pub use versioned_squads_multisig_program::instruction::VaultTransactionAccountsClose as VaultTransactionAccountsCloseData;
pub use versioned_squads_multisig_program::instruction::CreateVaultTransaction as VaultTransactionCreateData;
pub use versioned_squads_multisig_program::instruction::ExecuteVaultTransaction as VaultTransactionExecuteData;
// pub use versioned_squads_multisig_program::instructions::ConfigTransactionCreateArgs;
pub use versioned_squads_multisig_program::instructions::VersionedMultisigCreateArgsV2;
// pub use versioned_squads_multisig_program::instructions::ProposalCreateArgs;
pub use versioned_squads_multisig_program::instructions::VoteOnVersionedProposal;
// pub use versioned_squads_multisig_program::instructions::SpendingLimitUseArgs;
pub use versioned_squads_multisig_program::instructions::VaultTransactionCreateArgs;
use versioned_squads_multisig_program::TransactionMessage;
...
use crate::state::VersionedMultisig;
use crate::vault_transaction::{Error, VaultTransactionMessageExt};
use crate::ClientResult;

/// Gets a `Multisig` account from the chain.
pub async fn get_multisig(rpc_client: &RpcClient, multisig_key: &Pubkey) -> ClientResult<VersionedMultisig> {
    let multisig_account = rpc_client.get_account(multisig_key).await?;

    let multisig = VersionedMultisig::try_deserialize(&mut multisig_account.data.as_slice())
...
pub fn multisig_create_v2(
    ...
    Instruction {
        ...
        program_id: program_id.unwrap_or(versioned_squads_multisig_program::ID),
    }
}
...
pub fn proposal_approve(
    ...
    Instruction {
        accounts: accounts.to_account_metas(Some(false)),
        data: ProposalApproveData { approve }.data(),
        program_id: program_id.unwrap_or(versioned_squads_multisig_program::ID),
    }
}
...
pub fn vault_transaction_execute(
    ...
    let program_id = program_id.unwrap_or(versioned_squads_multisig_program::ID);
...
pub mod utils {
    // use versioned_squads_multisig_program::accounts::{ConfigTransactionExecute, SpendingLimitUse};
    ...
    //     use versioned_squads_multisig_program::accounts::SpendingLimitUse;
    ...
    //         let accounts = versioned_squads_multisig_program::accounts::ConfigTransactionExecute {
    //             multisig: Pubkey::new_unique(),
    //             member: Pubkey::new_unique(),
    //             proposal: Pubkey::new_unique(),
    //             transaction: Pubkey::new_unique(),
